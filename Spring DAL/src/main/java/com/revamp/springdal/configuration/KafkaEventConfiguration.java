...
public class KafkaEventConfiguration {
    ...
    @Value("${kafka.group.event}")
    public String group;

    @Bean
    public ConsumerFactory<String, MessageDto> consumerEventFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MessageDto> kafkaListenerContainerEventFactory() {
    ...
    @Bean
    public ProducerFactory<String, MessageDto> producerEventFactory() {
        Map<String, Object> props = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, MessageDto> kafkaEventTemplate() {
