...
public class KafkaBatchConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, MessageDto> consumerBatchFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MessageDto> kafkaListenerContainerBatchFactory() {
    ...
    @Bean
    public ProducerFactory<String, MessageDto> producerBatchFactory() {
        Map<String, Object> props = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, MessageDto> kafkaBatchTemplate() {
