package com.revamp.springbusiness.controller;
...
public class BusinessController {
    ...
    @KafkaListener(groupId = "revamp-event", topics = "event", containerFactory = "kafkaListenerContainerEventFactory")
    public void getMsgFromTopic(MessageDto data) throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException, JobParametersInvalidException, JobRestartException {
        ...
        jobLauncher.run(jobBusiness, jobParameters);
    }
}
